...
namespace MiniORM
{
    public abstract class DbContext
    {
                ...
                using (var transaction = this.connection.StartTransaction())
                {
                    foreach (IEnumerable dbSet in dbSets)
                    {
                        ...
                        var persistMethod = typeof(DbContext)
                            .GetMethod("Persist", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic)
            ...
            where TEntity : class, new()
        {
            ...
            foreach (var colection in collections)
            {
                var collectionType = colection.PropertyType.GenericTypeArguments.First();

                var mapCollectionMethod = typeof(DbContext)
                    .GetMethod("MapCollection", BindingFlags.Instance | BindingFlags.NonPublic)
                    .MakeGenericMethod(entityType, collectionType);

                mapCollectionMethod.Invoke(this, new object[] { dbSet, colection });
            }
        }
            ...
            where TDbSet : class, new() where TCollection : class, new()
        {
            ...
            foreach (var entity in dbSet)
            {
                ...
                var navigatinEntities = navigationDbSet
                    .Where(navigatinEntity => primaryKey.GetValue(navigatinEntity).Equals(primaryKeyValue))
                    .ToArray();

                ReflectionHelper.ReplaceBackingField(entity, collectionProperty.Name, navigatinEntities);
            }
        }
